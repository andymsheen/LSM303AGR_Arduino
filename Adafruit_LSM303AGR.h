...
/*=========================================================================
    ...
    typedef enum
    {                                                     // DEFAULT    TYPE
      LSM303_REGISTER_ACCEL_CFG_REG_A           = 0x1F,
      ...
      LSM303_REGISTER_ACCEL_TEMP_OUT_H_M       = 0x0D,
      LSM303_REGISTER_ACCEL_TEMP_OUT_L_M        = 0x0C
    } lsm303AccelRegisters_t;
    
    typedef enum
    {
      LSM303_REGISTER_OFFSET_X_REG_L_M          = 0x45,
      LSM303_REGISTER_OFFSET_X_REG_H_M          = 0x46,
      LSM303_REGISTER_OFFSET_Y_REG_L_M          = 0x47,
      LSM303_REGISTER_OFFSET_Y_REG_H_M          = 0x48,
      LSM303_REGISTER_OFFSET_Z_REG_L_M          = 0x49,
      LSM303_REGISTER_OFFSET_Z_REG_H_M          = 0x4A,
      LSM303_REGISTER_MAG_CRA_REG_M             = 0x60,
      LSM303_REGISTER_MAG_CRB_REG_M             = 0x61,
      LSM303_REGISTER_MAG_CRC_REG_M             = 0x62,
      LSM303_REGISTER_MAG_MR_REG_M              = 0x02,
      LSM303_REGISTER_MAG_OUT_X_H_M             = 0x69,
      LSM303_REGISTER_MAG_OUT_X_L_M             = 0x68,
      LSM303_REGISTER_MAG_OUT_Z_H_M             = 0x6D,
      LSM303_REGISTER_MAG_OUT_Z_L_M             = 0x6C,
      LSM303_REGISTER_MAG_OUT_Y_H_M             = 0x6B,
      LSM303_REGISTER_MAG_OUT_Y_L_M             = 0x6A,
      LSM303_REGISTER_MAG_SR_REG_Mg             = 0x67,
